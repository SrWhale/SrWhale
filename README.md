...
<p>
 Meu nome é <strong>Paulo Henrique</strong> eu sou um desenvolvedor iniciamente na linguagem <strong>[JavaScript]()</strong> utilizando principalmente <strong>[NodeJS](https://nodejs.org/en/)</strong>. Ainda faço aplicações extremamente básicas, como Bots para Discord (<a href="https://github.com/SrWhale/Pterodactyl-Panel">Clique aqui para acessar a SRC de um dos meus Bots</a>), mas pretendo ingressar no incrível mundo do <strong>Java</strong> e <strong>C#</strong>. 
